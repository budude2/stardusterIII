...
class HTU21D:
    ...
    def read_temperature(self):
        self.reset()
        data = self.bus.read_i2c_block_data(I2C_ADDR, CMD_TRIG_TEMP_HM, 3)
        return -46.85 + 175.72 * (data[0] * 256 + data[1]) / 65536
     
    def read_humidity(self):
        self.reset()
        data = self.bus.read_i2c_block_data(I2C_ADDR, CMD_TRIG_HUMID_HM, 3)
